"""
TS-BSmamba2 model implementation based on https://github.com/baijinglin/TS-BSmamba2
...
class MambaBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        try:
            ...
            raise ImportError(
                "mamba-ssm package is required for BSMamba2. Install with: pip install mamba-ssm"
            )
