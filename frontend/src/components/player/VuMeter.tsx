    ...
    <div className="vu-meter">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title={
            leftClipping
              ? "Left channel clipping! Click to reset"
              : "Left channel OK"
          }
        ...
        <div className="flex gap-[3px] items-center">
          {Array.from({ length: SEGMENT_COUNT }).map((_, i) => {
            ...
            return (
              <div
                // biome-ignore lint/suspicious/noArrayIndexKey: Meter has constant number of segments
                key={i}
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title={
            rightClipping
              ? "Right channel clipping! Click to reset"
              : "Right channel OK"
          }
          disabled={!onResetClip}
        />
