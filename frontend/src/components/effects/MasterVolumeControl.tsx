 ...
 * - Mute toggle button
 */
export function MasterVolumeControl({ volume, onVolumeChange }: MasterVolumeControlProps) {
      ...
      <div className="master-volume-controls">
        ...
        >
          ...
          <defs>
            ...
            <linearGradient id={`line-gradient-${isMuted ? 'muted' : 'normal'}`} x1="0" x2="0" y1="-8" y2="40" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor={isMuted ? "#ff6666" : "#4a9eff"} stopOpacity="0" />
              <stop offset="25%" stopColor={isMuted ? "#ff6666" : "#4a9eff"} stopOpacity="0.8" />
              <stop offset="100%" stopColor={isMuted ? "#ff6666" : "#4a9eff"} stopOpacity="0.8" />
            </linearGradient>
          ...
          <path
            d={`
              ...
              Z
            `}
            fill={isMuted ? "url(#volume-fill-gradient-muted)" : "url(#volume-fill-gradient)"}
