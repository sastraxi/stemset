...
def upgrade() -> None:
    ...
    op.add_column('recordings', sa.Column('date_recorded', sa.DateTime(timezone=False), nullable=True))

    # Add foreign key constraints
    op.create_foreign_key('fk_recordings_song_id', 'recordings', 'songs', ['song_id'], ['id'])
    op.create_foreign_key('fk_recordings_location_id', 'recordings', 'locations', ['location_id'], ['id'])
